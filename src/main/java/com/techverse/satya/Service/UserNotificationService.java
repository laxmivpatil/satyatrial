...
public class UserNotificationService {
	...
	UserNotificationRepository userNotificationRepository;
	  ...
	  public void sendDeleteAppointmentNotificationToUser(Appointment appointment, Users user) {
	        String message = String.format("\"Dear %s , your appointment scheduled for date %s and time %s has been deleted by our administration team.", user.getName(), appointment.getDate(),appointment.getTime());
	        
	        Long entityId = appointment.getId();
	        String title="Appointment Deleted";
